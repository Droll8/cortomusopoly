...
const io = new Server(server, {
    ...
    pingInterval: 25000,   // ping ogni 25s
    pingTimeout: 60000,    // se non riceve pong entro 60s → disconnesso (più clemente)
    transports: ['websocket', 'polling'],
    // Permette al client di "ricongiungersi" mantenendo gli eventi persi durante una breve disconnessione (max 2 min)
